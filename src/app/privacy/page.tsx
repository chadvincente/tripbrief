          ...
          <div className="prose dark:prose-invert max-w-none">
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
                <li><strong>Search Queries:</strong> Destinations and travel dates you enter to generate travel briefs</li>
                <li><strong>Email Addresses:</strong> When you voluntarily subscribe to our newsletter or updates</li>
                <li><strong>Contact Information:</strong> If you contact us for support or feedback</li>
              </ul>

              <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">Information Automatically Collected</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
                <li><strong>Analytics Data:</strong> Page views, session data, device information, and general location (via Umami Analytics)</li>
                <li><strong>Usage Patterns:</strong> How you interact with our service, popular destinations searched</li>
                <li><strong>Technical Data:</strong> IP address (for rate limiting), browser type, operating system</li>
                <li><strong>Server Logs:</strong> Request timestamps, response times, and error logs</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
                <li><strong>Service Delivery:</strong> Process your travel brief requests and generate personalized responses</li>
                <li><strong>Rate Limiting:</strong> Prevent service abuse and manage API costs using IP-based tracking</li>
                <li><strong>Analytics:</strong> Understand usage patterns and improve our service</li>
                <li><strong>Email Communications:</strong> Send newsletters, updates, and travel-related content (with your consent)</li>
                <li><strong>Service Improvement:</strong> Analyze popular destinations and optimize our AI responses</li>
                <li><strong>Technical Operations:</strong> Monitor service performance, debug issues, and ensure security</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">3. Data Sharing and Third Parties</h2>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                anonymized data about usage patterns to improve our service or for business development purposes.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
                <li><strong>Data Retention:</strong> Search queries are processed in real-time and not permanently stored</li>
                <li><strong>Rate Limiting Data:</strong> IP-based rate limiting data is temporary and automatically expires</li>
                <li><strong>Email Data:</strong> Newsletter subscriptions are stored securely until you unsubscribe</li>
                <li><strong>Analytics:</strong> Umami analytics data is stored according to their privacy policy</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
                <li><strong>Email Unsubscribe:</strong> You can unsubscribe from our newsletter at any time</li>
                ...
                <li><strong>Analytics Opt-out:</strong> You can disable analytics by using browser settings or ad blockers</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                TripBrief is not directed to children under 13. We do not knowingly collect personal information from children under 13.
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                TripBrief is operated from the United States. If you are using our service from outside the US,
